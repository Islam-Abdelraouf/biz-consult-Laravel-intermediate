            ...
            <div class="col-12">
                    ...
                    <div class="col-auto">
                        <form class="form-inline">
                            <div class="form-group d-none d-lg-inline">
                                ...
                                <div id="reportrange" class="text-muted px-2 py-2">
                    ...
                    <div class="card mb-4 shadow">
                        <div class="card-body">
                            <div class="row align-items-center mt-1">
                                <div class="col-12 col-lg-4 pl-4 text-left">
                                ...
                                <div class="col-6 col-lg-2 py-4 text-center">
                                    <p class="small text-muted mb-1">Today</p>
                                    <span class="h3">$2600</span><br />
                                    <span class="small text-muted">+20%</span>
                                    <span class="fe fe-arrow-up text-success fe-12"></span>
                                </div>
                                <div class="col-6 col-lg-2 mb-2 py-4 text-center">
                                    <p class="small text-muted mb-1">Goal Value</p>
                                    <span class="h3">$260</span><br />
                                    <span class="small text-muted">+6%</span>
                                    <span class="fe fe-arrow-up text-success fe-12"></span>
                                </div>
                                <div class="col-6 col-lg-2 py-4 text-center">
                                    <p class="small text-muted mb-1">Completions</p>
                ...
                <div class="row items-align-baseline">
                    <div class="col-md-12 col-lg-4">
                        <!-- card -->
                        <div class="card eq-card mb-4 shadow">
                            <div class="card-body mb-n3">
                                <div class="row items-align-baseline h-100">
                                    <div class="col-md-6 my-3">
                                        <p class="mb-0"><strong class="text-uppercase text-muted mb-0">Earning</strong>
                                        </p>
                                        <h3>$2,562</h3>
                    ...
                    <div class="col-md-12 col-lg-4 mb-4">
                        ...
                        <div class="card timeline shadow">
                            ...
                            <div class="card-body" data-simplebar
                                ...
                                <div class="timeline-item item-warning pb-3">
                                    <div class="pl-5">
                                ...
                                <div class="timeline-item item-success pb-3">
                                    <div class="pl-5">
                                        ...
                                        <div class="card d-inline-flex mb-2">
                                            <div class="card-body bg-light small rounded px-3 py-2"> Lorem
                                ...
                                <div class="timeline-item item-success pb-3">
                                    <div class="pl-5">
                                        <div class="mb-3"><strong>@Bertha Ball</strong><span
                                                ...
                                                on</span><strong>Advanced table</strong></div>
                                        <div class="card d-inline-flex mb-2">
                                            <div class="card-body bg-light px-3 py-2"> Lorem ipsum dolor
                                ...
                                <div class="timeline-item item-danger pb-3">
                                    <div class="pl-5">
                        ...
                        <div class="list-group-item bg-transparent">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted small my-0">Just create new layout Index, form,
                                        table</div>
                        ...
                        <div class="list-group-item bg-transparent">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted small my-0">Fusce dapibus, tellus ac cursus
                                        commodo</div>
                        ...
                        <div class="list-group-item bg-transparent">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted small my-0">New layout has been attached to the
                                        menu</div>
